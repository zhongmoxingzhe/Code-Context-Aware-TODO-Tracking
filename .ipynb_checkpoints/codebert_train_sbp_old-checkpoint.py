...
from TDReminder.BERT_model import codeModel2, Config, load_codeBERT
...
def save_model(epoch, model, training_stats):
    base_dir = '../autodl-tmp/codebert_sbp_java/epoch_' + str(epoch) + '/'
...
if __name__ == '__main__':
    ...
    dir_path = "./top_repos_10000/sbp_java/"
