...
from test_classifier.utils import *
from test_classifier.BERT_model import codeModel, Config, load_codeBERT
from test_classifier.loss_func import Focal_loss, DiceLoss
...
def train_model(dir_path, keyword):
    ...
    model = codeModel(config).to(config.device)
